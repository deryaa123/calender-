...
public class LittleCalendar extends JPanel {
	...
	public LittleCalendar() {
		...
		add(leftBtn);
		leftBtn.setIcon(new ImageIcon("C:\\Users\\ASUS\\eclipse-workspace\\calendar\\icon\\left-arrows.png"));
		...
		rightBtn.setIcon(new ImageIcon("C:\\Users\\ASUS\\eclipse-workspace\\calendar\\icon\\right-arrows.png"));
		add(rightBtn);
		...
		TimerTask task = new TimerTask() {
			...
			public void run() {
				...
				weekday.setFont(new Font("Verdana", Font.BOLD, 14));
