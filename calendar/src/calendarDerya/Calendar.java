...
public class Calendar extends JFrame {
			...
			public void run() {
				try {
					...
					ImageIcon img = new ImageIcon(
							"C:\\\\Users\\\\ASUS\\\\eclipse-workspace\\\\calendar\\icon\\calendar.png");
	...
	public Calendar() {
		...
		bckImg.setIcon(new ImageIcon("C:\\\\Users\\\\ASUS\\\\eclipse-workspace\\\\calendar\\\\icon\\back.jpg"));
		...
		save.setBounds(0, 360, 150, 35);
		save.setBackground(Color.decode("#5cb85c"));
		p.add(save);
		save.setVisible(false);
		save.setIcon(new ImageIcon("C:\\Users\\ASUS\\eclipse-workspace\\calendar\\icon\\ok-mark.png"));
		...
		cancel.setBounds(150, 360, 150, 35);
		cancel.setBackground(Color.decode("#d9534f"));
		p.add(cancel);
		cancel.setVisible(false);
		cancel.setIcon(new ImageIcon("C:\\Users\\ASUS\\eclipse-workspace\\calendar\\icon\\cross.png"));
